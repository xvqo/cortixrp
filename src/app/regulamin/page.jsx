      ...
      <div className="mx-auto grid max-w-page grid-cols-[260px_1fr] gap-16 px-8 pb-32 pt-16 [counter-reset:rules-counter] min-[1921px]:max-w-wide max-[1024px]:grid-cols-1 max-[1024px]:gap-8 max-md:px-6 max-md:pt-12 max-[480px]:px-5">
        ...
        <div className="min-w-0">
          ...
          <section id="2" data-chapter className="rules-section scroll-mt-24">
            ...
            <ol className="rules-list">
              <Rule id="2.1">Na serwerze zakazuje się używania wspomagaczy oraz wykorzystywania bugów — należy je niezwłocznie zgłosić do administracji bezpośrednio na Discordzie.</Rule>
          ...
          <section id="4" data-chapter className="rules-section scroll-mt-24">
            ...
            <ol className="rules-list">
              ...
              <Rule id="4.4">Dozwolone jest latanie helikopterem przez „zwykłych obywateli" w trakcie rozbudowanej akcji RP — nie dotyczy napadów helikopterem.</Rule>
          ...
          <section id="5" data-chapter className="rules-section scroll-mt-24">
            ...
            <ol className="rules-list">
              ...
              <Rule id="5.2">Po udzieleniu pierwszej pomocy — szczególnie po postrzale — należy jak najszybciej udać się do szpitala. Zbyt długa zwłoka może skutkować trwałym uszczerbkiem lub śmiercią postaci, uznanym za <Tag>FailRP</Tag>.</Rule>
          ...
          <div id="zasada" data-chapter className="rules-callout scroll-mt-24">
            ...
            <p>Jeżeli ktoś do Ciebie celuje — masz obowiązek podnieść ręce i wykonywać polecenia w trosce o swoje życie. Gdy ktoś pierwszy wyjmie broń, nie możesz zrobić tego samego — to traktowane jest jako nieposzanowanie życia. Gdy ktoś schowa broń, możliwy jest zwrot akcji po Twojej stronie. Jeśli jednak ciągle trzyma broń skierowaną w Twoją stronę, nie masz prawa jej wyciągnąć.</p>
